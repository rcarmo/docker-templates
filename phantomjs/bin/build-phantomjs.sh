...
apt-get remove -y build-essential g++ flex bison gperf ruby perl \
  libsqlite3-dev libfontconfig1-dev libicu-dev libssl-dev \
  libpng-dev libjpeg-dev python git; apt-get autoremove -y; apt-get clean
# Put the binary someplace obvious and remove the source tree
mv /home/phantomjs /bin/phantomjs; rm -rf /home/phantomjs
